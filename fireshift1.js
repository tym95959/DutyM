...
// ============================================
// 9. DE, OS, WK, NO DATABASE (shift-592f5)
// ============================================
const firebaseConfigShift = {
  apiKey: "AIzaSyCxWpEFvnts0MzZFD9eHqL1p67_hN57hWI",
  authDomain: "shift-592f5.firebaseapp.com",
  projectId: "shift-592f5",
  storageBucket: "shift-592f5.firebasestorage.app",
  messagingSenderId: "623517884832",
  appId: "1:623517884832:web:83cfefb2900f8dbfff84c5",
  measurementId: "G-76KTJNF77C"
};

// Initialize Firebase for DE/OS/WK/NO flights with a named app "shiftApp"
const shiftApp = !firebase.apps.some(app => app.name === "shiftApp") ? 
    firebase.initializeApp(firebaseConfigShift, "shiftApp") :
    firebase.app("shiftApp");

// Firestore reference for shift database
const shiftDb = shiftApp.firestore();

console.log("✅ Shift (DE/OS/WK/NO) Firebase initialized successfully!");
console.log("   Project: shift-592f5");
...
function getFirestoreForFlight(flightNo) {
  ...
  switch(flightPrefix) {
    ...
    // Condor (DE), Austrian (OS), Edelweiss (WK), Norwegian (NO)
    case 'DE':
    case 'OS':
    case 'WK':
    case 'NO':
      console.log(`✈️ ${flightPrefix} flight detected (${flightNo}) - using Shift database`);
      return shiftDb;
      
    // Default database for all other airlines
    default:
...
function getFirestoreNameForFlight(flightNo) {
  ...
  switch(flightPrefix) {
    ...
    case 'OS': 
    case 'WK': 
    case 'NO': return "Shift Database (shift-592f5)";
...
// New databases
window.shiftDb = shiftDb;            // DE, OS, WK, NO database (shift-592f5)
...
console.log("9. Shift DB (DE/OS/WK/NO): shift-592f5");
console.log("==========================================");
console.log("Flight routing rules:");
console.log("  BA → cardentryba");
console.log("  EK → cardentryek");
console.log("  QR → cardentryqr");
